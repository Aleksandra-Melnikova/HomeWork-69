...
import { loadingGeiInfo, selectInfo } from '../../store/slices/selialsNameSlices.ts';
  ...
  return (
    <>
      ...
      {getInfoLoading ? <Spinner/> : <div>
        ...
        <span className="fs-4 d-block my-3"><strong> {filmInfo.language}</strong></span>
